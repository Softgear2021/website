              ...
              <div>
                ...
                <form className="flex">
                  <input 
                    ...
                    className="flex-grow px-4 py-2 rounded-l-md bg-gray-700 border-2 border-blue-500 text-white placeholder-gray-400 focus:outline-none focus:border-blue-400"
                  />
                  <button 
                    type="submit" 
                    className="px-6 py-2 bg-blue-500 text-white font-medium rounded-r-md hover:bg-blue-400 transition-colors duration-300"
                  >
                    Subscribe
                  </button>
                </form>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-400">
                  <li className="flex items-center">
                    ...
                    Plot No B-792, DDA Flats, Bindapur Dwarka Sector 1, Pkt 3 New Delhi - 110059
                  </li>
                  <li className="flex items-center">
                    <svg className="w-4 h-4 mr-2 text-blue-400" fill="currentColor" viewBox="0 0 20 20">
